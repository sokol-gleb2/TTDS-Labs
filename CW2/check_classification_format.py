    ...
    with open(path) as infile:
        ...
        for i,line in enumerate(infile.readlines()):
            ...
            if len(parts) != 14:
                ...
                system,split,pp,rp,fp,pn,rn,fn,pn,rn,fn,pm,rm,fm = line.split(',')
                ...
                if split not in 'train dev test'.split():
                    ...
                    correct = False
                for j,score in enumerate([pp,rp,fp,pn,rn,fn,pn,rn,fn,pm,rm,fm]):
                    try:
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        check_file(os.path.join(script_dir, sys.argv[1]))
